def MinWindowSubstring(strArr):
    ...
    for j, char in enumerate(main_str):
        ...
        if (char in search_str_letter_freq) and (
            search_str_letter_freq[char] == window_str_letter_freq[char]
        ):
        ...
        while num_letters_found == num_letters_needed:
            ...
            if (leftmost_letter in search_str_letter_freq) and (
                window_str_letter_freq[leftmost_letter]
                < search_str_letter_freq[leftmost_letter]
            ):
                num_letters_found -= 1
